lexicon <- function(){
  ...
  key_words[["Labormarket_boom"]]=c(
    ...
    "the participation rate has risen",
    ...
    "employment recorded anexceptionally large expansion",
    "unemployment rate declined",
    "employment rose",
    "wage pressure",
    "employment improved",
  ...
  key_words[["Housing_crisis"]]=c(
    ...
    "decline in real residential investment",
  ...
  key_words[["Losening_monetary_policy"]]=c(
    ...
    "acceleration in the monetary aggregates",
    "relax stance of policy",
    "lowering of the discount rate",
    "growth of the monetary aggregates",
    "Monetary policy remains highly accommodative",
    "discount rate was cut",
    "interest rates have declined",
    "monetary policy to be accomodative",
    "monetary aggregates grew",
  ...
  key_words[["Tightening_monetary_policy"]]=c(
    ...
    "tightening of financial markets",
    ...
    "less accomodative",
    "slowing in monetary expansion",
    "pressures on interest rates",
    "federal funds rate rose",
    "withdrawal of monetary stimulus",
    "curb inflationary pressure",
    "control of inflationary",
    "monetary policy was expected to move in the direction uf restraint",
    "battle against inflation",
    "rise in interest rates",
    "monetary restraint",
    "stabilization program",
    "direct restraint on wages and prices",
    "surge in interest rate",
    "containing the growth of the monetary aggregates",
    "slowing in the growth of the monetary aggregates",
    "anti-inflation program",
    "direct restraint over wages",
    "direct restraint on wages",
    "growth of monetary aggregates",
    "specifal credit restraint program",
    "raised reserve requirements",
    "restrain the expansion of the reserve aggregates",
    "non-inflationary rates of monetary growth",
    "slowing in the rate of monetary growth",
    "credit restraint program",
    "restrain in the growth of money",
    ...
    "slowing in the growth of monetary aggregates",
    "avoid strong demand pressure",
    "rise in the discount rate",
    "supplementary reserve requirement",
    "slowing in the rate of monetary expansion",
    "deceleration in monetary expansion",
    "weakness in monetary expansion",
    "higher interest rates",
    "rising short term interest rate",
    "restrain the growth of the monetary",
  ...
  key_words[["Expansion"]]=c(
    ...
    "economy had continued to expand",
    "expansion of GNP",
    "rebound in activity",
  ...
  key_words[["Fiscal_stimulus"]]=c("fiscal_stimulus",
                                   ...
                                   "expansion of spending programs",
                                   "government spending tended to rise",
                                   "fiscal loosening",
  ...
  key_words[["Fiscal_consolidation"]]=c(
    ...
    "fiscal_restraint",
    "fiscal cuts",
    "restraining the growth of expenditures",
    "reduction of fiscal stimulus",
