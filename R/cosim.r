...
cosim = function(table_N_occurence, vec1, vec2) {
    # formula for the cosinus similiarity that provides the distance/similarity
    # between two vectors here two crisis pararmeters: table_N_occurence: a
    # tibble with documents in rows and number of occurence of each type of
    # crisi in columns vec1: the name of the column 1 to analyse vec2: the name
    # of the column 2 to analyse output: a number providing the similarity
