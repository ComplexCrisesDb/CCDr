...
run_tf_update=function(path_tf_to_update=paste0(root_path,"/3. Data/IMF Letters of Intents/tf_crisis_words.RData"),
                       ...
                       export_path=paste0(root_path,"/3. Data/IMF Letters of Intents/tf_crisis_words.RData"),
                       parrallel=T){
