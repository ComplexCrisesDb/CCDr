...
<ol>
  ...
  In the scraping process, we might end up with some URLs of problematic documents i.e. documents on which we do not want to conduct the tf extraction. In our example, we downloaded many working paper together with . The logical step to take would be the manually erase these documents: this, in turn, would be tedious and take a long time. <br> <br>
