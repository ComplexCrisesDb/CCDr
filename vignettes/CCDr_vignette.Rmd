...
tf_matrix=ccdr.tf(corpus,"Severe_recession")
tf_matrix
```
...
ccdr.tfs(corpus=corpus,keyword_list=ccdr.lexicon()[mycategories]) %>% head()
...
scrap.ccdr.tfs(urls =url_links,keyword_list = c("Currency_crisis","Balance_payment_crisis"))
```
...
updated_tf=ccdr.tfs.update(file_tf_to_update = "temp/tf/ccd_tf.RData",
                corpus_file = "temp/corpus/corpus_1.RData",
